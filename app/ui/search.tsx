    ...
    <div className="flex flex-col items-center w-full max-w-4xl">
      ...
      >
        <input
          ...
          className="flex-grow bg-transparent outline-none text-gray-950 placeholder-amber-800 text-md md:text-lg mb-4 md:mb-0"
        />
        <button
          type="submit"
          className="md:ml-2 px-4 py-2 bg-amber-700 text-white rounded-lg hover:bg-amber-800 transition hover:scale-105 active:scale-95"
        >
          Ignite
        </button>
      </form>
